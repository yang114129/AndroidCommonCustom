package com.yang.custom.widget;
...
public class ReadTextView extends AppCompatEditText {
    ...
    private boolean isForbiddenActionMenu = false;     // 是否需要禁止弹出菜单 ，默认false
    ...
    public ReadTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs,
                R.styleable.ReadTextView);
        isTextJustify = mTypedArray.getBoolean(R.styleable.ReadTextView_textJustify, true);
        isForbiddenActionMenu = mTypedArray.getBoolean(R.styleable.ReadTextView_forbiddenActionMenu, false);
        mTextHighlightColor = mTypedArray.getColor(R.styleable.ReadTextView_textHeightColor, 0x60ffeb3b);
        mTypedArray.recycle();
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                Log.d("ReadTextview", "ACTION_DOWN");
            ...
            case MotionEvent.ACTION_MOVE:
                Log.d("ReadTextview", "ACTION_MOVE");
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (isLongPress) {
                    ...
                    Toast.makeText(getContext(),this.getText().toString().substring(layout.getLineStart(currentLine),layout.getLineEnd(currentLine)),Toast.LENGTH_SHORT).show();
